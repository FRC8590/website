    ...
    return (
        <div className="h-[40rem] w-full flex items-center justify-center ">
            <PinContainer title="Donate Now!" href={DONATE_URL}>
                <div className="flex justify-center items-center w-full basis-full flex-col tracking-tight sm:basis-1/2 h-full dark:bg-grid-small-white/[0.05] bg-grid-small-black/[0.2] rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-zinc-950 hover:dark:bg-zinc-900 bg-zinc-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] hover:shadow-lg transition-all">
                    <div className="text-base md:text-xl !m-0 !p-0 font-light w-full">
                        ...
                        <div className="grid grid-rows-1 grid-cols-3 auto-rows-fr gap-6 px-4">
                            <div className="relative aspect-square">
                                <Image
                                    src="/pictures/why-donate-1.jpg"
                                    fill
                                    alt="Team Image"
                                    className="rounded-xl grayscale hover:grayscale-0 object-cover"
                                />
                            </div>
                            <div className="relative aspect-square">
                                <Image
