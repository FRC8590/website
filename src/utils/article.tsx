...
export default function Article(
    ...
    return (
        ...
        >
            <GridBackground>
                <div
                    className={`flex space-y-6 md:space-y-0 items-center md:items-start md:flex-row flex-col md:max-h-[36rem] overflow-auto ${
                        props.flip ? "md:flex-row-reverse" : ""
                    }`}
                >
                    <div className="flex flex-col p-2 md:p-8 space-y-3 md:min-w-96 min-w-0 overflow-auto">
