...
const CYCLES: Record<number, string> = {
    ...
    2: `bg-[radial-gradient(circle_farthest-side_at_0_100%,#9c0015,transparent),radial-gradient(circle_farthest-side_at_100%_0,#f5841b,transparent),radial-gradient(circle_farthest-side_at_100%_100%,#ff17a2,transparent),radial-gradient(circle_farthest-side_at_0_0,#79f51b,#ff4a77)]`,
    3: `bg-[radial-gradient(circle_farthest-side_at_0_100%,#e11d48,transparent),radial-gradient(circle_farthest-side_at_100%_0,#e11d48,transparent),radial-gradient(circle_farthest-side_at_100%_100%,#e11d48,transparent),radial-gradient(circle_farthest-side_at_0_0,#e11d48,#e11d48)]`,
    ...
    return (
        ...
        >
            <motion.div
                ...
                className={cn(
                    `absolute inset-0 rounded-3xl z-[1] opacity-20 group-hover:opacity-50 ${
                        blurClass || "blur-xl"
