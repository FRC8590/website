...
export const BackgroundBeamsWithCollision = ({
    ...
    return (
        ...
        >
            ...
            <div
                ref={containerRef}
                className="absolute bottom-0 bg-zinc-100 w-full inset-x-0 pointer-events-none"
                style={{
                    boxShadow:
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="absolute -inset-x-10 top-0 m-auto h-2 w-10 rounded-full bg-gradient-to-r from-transparent via-blue-300 to-transparent blur-sm"
            ></motion.div>
            {spans.map((span) => (
                <motion.span
                    key={span.id}
                    ...
                    className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-sky-300 to-blue-500"
                />
            ))}
        </div>
    );
